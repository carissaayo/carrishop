...
const ShopSidebar = ({ values, setValues, sideBar, setSideBar }) => {
  return (
    <main
      className={`md:hidden bg-primaryColor w-[70%] h-full bg-primaryColor pt-10  z-50  transform-translate duration-500 ease-in-out ${
    ...
    >
        ...
        <section className={`w-[95%] h-full overflow-y-scroll pb-14  `}>
          {/* Categories */}
          <Categories />
          {/* Filters */}
          <Filter />
