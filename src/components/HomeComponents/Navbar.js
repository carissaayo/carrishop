...
const [openAvatar, setOpenAvatar] = useState(false)
  ...
  return (
    <header
      ...
      } sticky w-full h-[100px] sm:h-[100px] flex bg-primaryColor justify-between items-center  px-2 sm:px-10 2xl:pl-4 gap-4 sm:gap-8 md:gap-4 2xl:gap-10 z-30 relative`}
    >
